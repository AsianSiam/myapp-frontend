...
const Header = () => {
  return (
    <header className="modern-black-card border-l-0 border-r-0 border-t-0 rounded-none sticky top-0 z-[100] py-4 backdrop-blur-md bg-app-background/98 shadow-sm border-b border-app-muted/30">
