...
const SearchPage = () => {
    ...
    if (city === undefined) {
        return <span>Please provide a city to search</span>
    }
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5'>
            ...
            <div id='main-content' className='flex flex-col gap-5'>
                <SearchBar searchQuery={searchState.searchQuery} onSubmit={setSearchQuery} placeholder='Search for cuisines or restaurant name' onReset={resetSearch} />
                <div className='flex justify-between flex-col gap-3 lg:flex-row'>
                    <SearchResultInfo total={results.pagination.total} city={city} />
                    <SortOptionDropDown sortOption={searchState.sortOption} onChange={(value) => setSortOption(value)} />
                </div>
                {results.data.map((restaurant) => (
                <SearchResultCards key={restaurant._id} restaurant={restaurant} />
                ))}
